...
<k-pagination v-bind:limit="limit" v-bind:url="url" v-bind:dis-event="disEvent" v-bind:rows="rows" v-bind:total="total" v-bind:page-no="pageNo" v-bind:start="start" v-bind:end="end"></k-pagination>
</div>
</template>
